...
BEGIN
  ...
  IF next_version = 1 THEN
    CREATe TABLE "pool_metadata_reference"("id" SERIAL8  PRIMARY KEY UNIQUE,"pool_id" text NOT NULL,"url" text NOT NULL,"hash" hash32type NOT NULL);
    ALTER TABLE "pool_metadata_reference" ADD CONSTRAINT "unique_pool_metadata_reference" UNIQUE("pool_id","hash");
    CREATe TABLE "pool_metadata"("id" SERIAL8  PRIMARY KEY UNIQUE,"pool_id" text NOT NULL,"ticker_name" text NOT NULL,"hash" hash32type NOT NULL,"metadata" text NOT NULL,"pmr_id" INT8 NULL);
    ALTER TABLE "pool_metadata" ADD CONSTRAINT "unique_pool_metadata" UNIQUE("pool_id","hash");
    ALTER TABLE "pool_metadata" ADD CONSTRAINT "pool_metadata_pmr_id_fkey" FOREIGN KEY("pmr_id") REFERENCES "pool_metadata_reference"("id");
    ...
    CREATe TABLE "reserved_ticker"("id" SERIAL8  PRIMARY KEY UNIQUE,"name" text NOT NULL,"pool_hash" hash32type NOT NULL);
