...
BEGIN
  ...
  IF next_version = 1 THEN
    ...
    CREATe TABLE "pool_metadata"("id" SERIAL8  PRIMARY KEY UNIQUE,"pool_id" text NOT NULL,"ticker_name" text NOT NULL,"hash" base16type NOT NULL,"metadata" text NOT NULL,"pmr_id" INT8 NULL);
